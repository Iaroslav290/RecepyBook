...
let theMostPopularElement = QuickAccessLineElement(image: UIImage(named: "popular")!, title: "The most popular", backgroundColor: UIColor(red: 244/255, green: 254/255, blue: 253/255, alpha: 1))

var quickElements: [QuickAccessLineElement] = [newDishesElemeny, nowInTrendElement, theMostPopularElement]
