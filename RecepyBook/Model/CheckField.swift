...
class CheckField{
    ...
    private func validView(_ parentView: UIView, _ field: UITextField, _ valid: Bool){
        if valid{
            field.layer.borderColor = #colorLiteral(red: 0.9410838485, green: 0.9412415624, blue: 0.9410631061, alpha: 1)
//            parentView.backgroundColor = #colorLiteral(red: 0.9410838485, green: 0.9412415624, blue: 0.9410631061, alpha: 1)

        } else {
            field.layer.borderColor = #colorLiteral(red: 1, green: 0.2566739321, blue: 0.3427716792, alpha: 1)
